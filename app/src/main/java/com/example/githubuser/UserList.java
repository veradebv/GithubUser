...
public class UserList extends RecyclerView.Adapter<UserList.ListViewHolder> {
    ...
    @NonNull
    @Override
    public UserList.ListViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_user, viewGroup, false);
        return new ListViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UserList.ListViewHolder holder, int position) {
